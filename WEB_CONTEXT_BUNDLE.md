...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-ce1f96361acb3a66"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-ce1f96361acb3a66",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-ce1f96361acb3a66",
        "url": "https://en.wikipedia.org/wiki/Albertson_conjecture"
      }
    ],
    "statement": {
      "language": "en",
      "text": "The Albertson conjecture : the crossing number can be lower-bounded by the crossing number of a complete graph with the same chromatic number",
      "version": 1
    },
    "title": "Albertson conjecture",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "b07acffe4857db74d9e066a8c459481b6a86b58f63f56bb84fd0698e15776ac4"
}
```
